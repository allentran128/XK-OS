...
main(int argc, char *argv[])
{
  ...
  1e:	48 be fb 0e 00 00 00 	movabs $0xefb,%rsi
  25:	00 00 00 
    printf(2, "Usage: rm files...\n");
  28:	b0 00                	mov    $0x0,%al
  2a:	e8 81 00 00 00       	callq  b0 <printf>
    exit();
  2f:	e8 b4 0a 00 00       	callq  ae8 <exit>
  ...
  44:	0f 8d 54 00 00 00    	jge    9e <main+0x9e>
    if(unlink(argv[i]) < 0){
  4a:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  4e:	48 63 4d ec          	movslq -0x14(%rbp),%rcx
  52:	48 8b 3c c8          	mov    (%rax,%rcx,8),%rdi
  56:	e8 dd 0a 00 00       	callq  b38 <unlink>
  5b:	83 f8 00             	cmp    $0x0,%eax
  5e:	0f 8d 27 00 00 00    	jge    8b <main+0x8b>
  64:	bf 02 00 00 00       	mov    $0x2,%edi
  69:	48 be 0f 0f 00 00 00 	movabs $0xf0f,%rsi
  70:	00 00 00 
      printf(2, "rm: %s failed to delete\n", argv[i]);
  73:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
  77:	48 63 4d ec          	movslq -0x14(%rbp),%rcx
  7b:	48 8b 14 c8          	mov    (%rax,%rcx,8),%rdx
  7f:	b0 00                	mov    $0x0,%al
  81:	e8 2a 00 00 00       	callq  b0 <printf>
      break;
  86:	e9 13 00 00 00       	jmpq   9e <main+0x9e>
    }
  }
  8b:	e9 00 00 00 00       	jmpq   90 <main+0x90>
  for(i = 1; i < argc; i++){
  90:	8b 45 ec             	mov    -0x14(%rbp),%eax
  93:	83 c0 01             	add    $0x1,%eax
  96:	89 45 ec             	mov    %eax,-0x14(%rbp)
  99:	e9 a0 ff ff ff       	jmpq   3e <main+0x3e>

  exit();
  9e:	e8 45 0a 00 00       	callq  ae8 <exit>
  a3:	89 45 e4             	mov    %eax,-0x1c(%rbp)
...
printf(int fd, char *fmt, ...)
{
 ...
 44e:	48 b8 28 0f 00 00 00 	movabs $0xf28,%rax
 455:	00 00 00 
          s = "(null)";
...
0000000000000540 <printint64>:
{
 ...
 5aa:	40 8a 34 15 50 11 00 	mov    0x1150(,%rdx,1),%sil
 5b1:	00 
...
0000000000000640 <printint>:
{
 ...
 69c:	40 8a 34 0d 70 11 00 	mov    0x1170(,%rcx,1),%sil
 6a3:	00 
...
free(void *ap)
{
 ...
 bc4:	48 8b 3c 25 88 11 00 	mov    0x1188,%rdi
 bcb:	00 
 ...
 cfc:	48 89 04 25 88 11 00 	mov    %rax,0x1188
 d03:	00 
}
 d04:	5d                   	pop    %rbp
 d05:	c3                   	retq   
...
malloc(uint nbytes)
{
 ...
 d32:	89 7d dc             	mov    %edi,-0x24(%rbp)
  if((prevp = freep) == 0){
 d35:	48 8b 04 25 88 11 00 	mov    0x1188,%rax
 d3c:	00 
 d3d:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
 d41:	48 83 f8 00          	cmp    $0x0,%rax
 d45:	0f 85 29 00 00 00    	jne    d74 <malloc+0x64>
 d4b:	48 b8 90 11 00 00 00 	movabs $0x1190,%rax
 d52:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 d55:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
 d59:	48 89 04 25 88 11 00 	mov    %rax,0x1188
 d60:	00 
 d61:	48 89 04 25 90 11 00 	mov    %rax,0x1190
 d68:	00 
    base.s.size = 0;
 d69:	c7 04 25 98 11 00 00 	movl   $0x0,0x1198
 d70:	00 00 00 00 
  }
 ...
 de9:	48 89 04 25 88 11 00 	mov    %rax,0x1188
 df0:	00 
      return (void*)(p + 1);
 ...
 e06:	48 3b 04 25 88 11 00 	cmp    0x1188,%rax
 e0d:	00 
...
0000000000000e70 <morecore>:
{
 ...
 ee0:	e8 cb fc ff ff       	callq  bb0 <free>
  return freep;
 ee5:	48 8b 04 25 88 11 00 	mov    0x1188,%rax
 eec:	00 
