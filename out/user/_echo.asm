...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++)
   f:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
  16:	8b 45 ec             	mov    -0x14(%rbp),%eax
  19:	3b 45 f8             	cmp    -0x8(%rbp),%eax
  1c:	0f 8d 5a 00 00 00    	jge    7c <main+0x7c>
  22:	bf 01 00 00 00       	mov    $0x1,%edi
  27:	48 be db 0e 00 00 00 	movabs $0xedb,%rsi
  2e:	00 00 00 
  31:	48 b8 e2 0e 00 00 00 	movabs $0xee2,%rax
  38:	00 00 00 
  3b:	48 b9 e0 0e 00 00 00 	movabs $0xee0,%rcx
  42:	00 00 00 
    printf(1, "%s%s", argv[i], i+1 < argc ? " " : "\n");
  45:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
  49:	4c 63 45 ec          	movslq -0x14(%rbp),%r8
  4d:	4a 8b 14 c2          	mov    (%rdx,%r8,8),%rdx
  51:	44 8b 4d ec          	mov    -0x14(%rbp),%r9d
  55:	41 83 c1 01          	add    $0x1,%r9d
  59:	44 8b 55 f8          	mov    -0x8(%rbp),%r10d
  5d:	45 39 d1             	cmp    %r10d,%r9d
  60:	48 0f 4c c1          	cmovl  %rcx,%rax
  64:	48 89 c1             	mov    %rax,%rcx
  67:	b0 00                	mov    $0x0,%al
  69:	e8 22 00 00 00       	callq  90 <printf>
  for(i = 1; i < argc; i++)
  6e:	8b 45 ec             	mov    -0x14(%rbp),%eax
  71:	83 c0 01             	add    $0x1,%eax
  74:	89 45 ec             	mov    %eax,-0x14(%rbp)
  77:	e9 9a ff ff ff       	jmpq   16 <main+0x16>
  exit();
  7c:	e8 47 0a 00 00       	callq  ac8 <exit>
  81:	89 45 e8             	mov    %eax,-0x18(%rbp)
  84:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
  8b:	00 00 00 
  8e:	66 90                	xchg   %ax,%ax
...
printf(int fd, char *fmt, ...)
{
 ...
 42e:	48 b8 e4 0e 00 00 00 	movabs $0xee4,%rax
 435:	00 00 00 
          s = "(null)";
...
0000000000000520 <printint64>:
{
 ...
 58a:	40 8a 34 15 10 11 00 	mov    0x1110(,%rdx,1),%sil
 591:	00 
...
0000000000000620 <printint>:
{
 ...
 67c:	40 8a 34 0d 30 11 00 	mov    0x1130(,%rcx,1),%sil
 683:	00 
...
free(void *ap)
{
 ...
 ba4:	48 8b 3c 25 48 11 00 	mov    0x1148,%rdi
 bab:	00 
 ...
 cdc:	48 89 04 25 48 11 00 	mov    %rax,0x1148
 ce3:	00 
}
 ce4:	5d                   	pop    %rbp
 ce5:	c3                   	retq   
...
malloc(uint nbytes)
{
 ...
 d12:	89 7d dc             	mov    %edi,-0x24(%rbp)
  if((prevp = freep) == 0){
 d15:	48 8b 04 25 48 11 00 	mov    0x1148,%rax
 d1c:	00 
 d1d:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
 d21:	48 83 f8 00          	cmp    $0x0,%rax
 d25:	0f 85 29 00 00 00    	jne    d54 <malloc+0x64>
 d2b:	48 b8 50 11 00 00 00 	movabs $0x1150,%rax
 d32:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 d35:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
 d39:	48 89 04 25 48 11 00 	mov    %rax,0x1148
 d40:	00 
 d41:	48 89 04 25 50 11 00 	mov    %rax,0x1150
 d48:	00 
    base.s.size = 0;
 d49:	c7 04 25 58 11 00 00 	movl   $0x0,0x1158
 d50:	00 00 00 00 
  }
 ...
 dc9:	48 89 04 25 48 11 00 	mov    %rax,0x1148
 dd0:	00 
      return (void*)(p + 1);
 ...
 de6:	48 3b 04 25 48 11 00 	cmp    0x1148,%rax
 ded:	00 
...
0000000000000e50 <morecore>:
{
 ...
 ec0:	e8 cb fc ff ff       	callq  b90 <free>
  return freep;
 ec5:	48 8b 04 25 48 11 00 	mov    0x1148,%rax
 ecc:	00 
