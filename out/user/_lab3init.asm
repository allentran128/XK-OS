...
main(void)
{
   ...
   8:	48 bf 04 0f 00 00 00 	movabs $0xf04,%rdi
   f:	00 00 00 
  12:	be 02 00 00 00       	mov    $0x2,%esi
  if(open("console", O_RDWR) < 0){
  17:	e8 0c 0b 00 00       	callq  b28 <open>
  1c:	83 f8 00             	cmp    $0x0,%eax
  1f:	0f 8d 32 00 00 00    	jge    57 <main+0x57>
  25:	48 bf 04 0f 00 00 00 	movabs $0xf04,%rdi
  2c:	00 00 00 
  2f:	b8 01 00 00 00       	mov    $0x1,%eax
    mknod("console", 1, 1);
  34:	89 c6                	mov    %eax,%esi
  36:	89 c2                	mov    %eax,%edx
  38:	e8 f3 0a 00 00       	callq  b30 <mknod>
  3d:	48 bf 04 0f 00 00 00 	movabs $0xf04,%rdi
  44:	00 00 00 
  47:	be 02 00 00 00       	mov    $0x2,%esi
    open("console", O_RDWR);
  4c:	89 45 f8             	mov    %eax,-0x8(%rbp)
  4f:	e8 d4 0a 00 00       	callq  b28 <open>
  54:	89 45 f4             	mov    %eax,-0xc(%rbp)
  57:	31 ff                	xor    %edi,%edi
  }
  dup(0);  // stdout
  59:	e8 02 0b 00 00       	callq  b60 <dup>
  5e:	31 ff                	xor    %edi,%edi
  dup(0);  // stderr
  60:	89 45 f0             	mov    %eax,-0x10(%rbp)
  63:	e8 f8 0a 00 00       	callq  b60 <dup>
  68:	48 bf fb 0e 00 00 00 	movabs $0xefb,%rdi
  6f:	00 00 00 
  72:	48 be 50 11 00 00 00 	movabs $0x1150,%rsi
  79:	00 00 00 

  exec("lab3test", argv);
  7c:	89 45 ec             	mov    %eax,-0x14(%rbp)
  7f:	e8 9c 0a 00 00       	callq  b20 <exec>
  84:	bf 01 00 00 00       	mov    $0x1,%edi
  89:	48 be 0c 0f 00 00 00 	movabs $0xf0c,%rsi
  90:	00 00 00 
  printf(1, "lab3init: exec failed\n");
  93:	89 45 e8             	mov    %eax,-0x18(%rbp)
  96:	b0 00                	mov    $0x0,%al
  98:	e8 13 00 00 00       	callq  b0 <printf>
  exit();
  9d:	e8 46 0a 00 00       	callq  ae8 <exit>
  a2:	89 45 e4             	mov    %eax,-0x1c(%rbp)
  a5:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
  ac:	00 00 00 
  af:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 44e:	48 b8 23 0f 00 00 00 	movabs $0xf23,%rax
 455:	00 00 00 
          s = "(null)";
...
0000000000000540 <printint64>:
{
 ...
 5aa:	40 8a 34 15 60 11 00 	mov    0x1160(,%rdx,1),%sil
 5b1:	00 
...
0000000000000640 <printint>:
{
 ...
 69c:	40 8a 34 0d 80 11 00 	mov    0x1180(,%rcx,1),%sil
 6a3:	00 
...
free(void *ap)
{
 ...
 bc4:	48 8b 3c 25 98 11 00 	mov    0x1198,%rdi
 bcb:	00 
 ...
 cfc:	48 89 04 25 98 11 00 	mov    %rax,0x1198
 d03:	00 
}
 d04:	5d                   	pop    %rbp
 d05:	c3                   	retq   
...
malloc(uint nbytes)
{
 ...
 d32:	89 7d dc             	mov    %edi,-0x24(%rbp)
  if((prevp = freep) == 0){
 d35:	48 8b 04 25 98 11 00 	mov    0x1198,%rax
 d3c:	00 
 d3d:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
 d41:	48 83 f8 00          	cmp    $0x0,%rax
 d45:	0f 85 29 00 00 00    	jne    d74 <malloc+0x64>
 d4b:	48 b8 a0 11 00 00 00 	movabs $0x11a0,%rax
 d52:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 d55:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
 d59:	48 89 04 25 98 11 00 	mov    %rax,0x1198
 d60:	00 
 d61:	48 89 04 25 a0 11 00 	mov    %rax,0x11a0
 d68:	00 
    base.s.size = 0;
 d69:	c7 04 25 a8 11 00 00 	movl   $0x0,0x11a8
 d70:	00 00 00 00 
  }
 ...
 de9:	48 89 04 25 98 11 00 	mov    %rax,0x1198
 df0:	00 
      return (void*)(p + 1);
 ...
 e06:	48 3b 04 25 98 11 00 	cmp    0x1198,%rax
 e0d:	00 
...
0000000000000e70 <morecore>:
{
 ...
 ee0:	e8 cb fc ff ff       	callq  bb0 <free>
  return freep;
 ee5:	48 8b 04 25 98 11 00 	mov    0x1198,%rax
 eec:	00 
